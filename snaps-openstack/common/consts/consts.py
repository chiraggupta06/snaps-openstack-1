...
MULTI_NODE_KOLLA_COMPUTE_YAML_PIKE=KOLLA_YAML+"multinode_kolla_compute_pike.yaml"
MULTI_NODE_KOLLA_CONTROLLER_YAML_PIKE=KOLLA_YAML+"multinode_kolla_controller_pike.yaml"
SINGLE_NODE_KOLLA_YAML_PIKE=KOLLA_YAML+"single_node_kolla_pike.yaml"
